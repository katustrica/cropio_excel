...
class ExcelFile(ABC):
    ...
    def __init__(self, infos: list[ExcelInfo], file_location: str, path_to_save: str = '.\\'):
...
class WaybillExcel(ExcelFile):
    ...
    def __init__(self, infos: list[ExcelInfo], file_location: str = FILE_LOCATION_SIMPLE, path_to_save: str = '.\\'):
        """ Создаем копию дефолтного файла при создании экземпляра """
...
class KamazExcel(ExcelFile):
    ...
    def __init__(self, infos: list[ExcelInfo], file_location: str = FILE_LOCATION_KAMAZ, path_to_save: str = '.\\'):
        """ Создаем копию дефолтного файла при создании экземпляра """
